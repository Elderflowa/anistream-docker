import { getAnimeByAnilistId, getEpisodeUrls } from "./anicli.js";
import { getUserWatchStatus, updateUserWatchList } from "./anilist.js";

export async function getAnimeStreams(animeId, title, episodeNumber) {
...
export async function updateUserWatchStatusOnAnilist(
    anilistToken,
    animeId,
    episodeNumber,
    streams,
